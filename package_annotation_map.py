...
PATH_TO_PACKAGE_MAP = {
    ...
    "chia/types/signing_mode.py": "chips",
    ...
    "chia/util/recursive_replace.py": "testing",
    ...
    "chia/wallet/puzzles/load_clvm.py": "chialisp",
...
vals = set(PATH_TO_PACKAGE_MAP.values())

#print("d = {}")
for val in vals:
    d = {k: v for k, v in PATH_TO_PACKAGE_MAP.items() if v == val}
    #print(f"d.update({d})")
